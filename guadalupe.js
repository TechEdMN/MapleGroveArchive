...
function openSecureBrowser1() {
    var urls1 = '/maplegrovecitylimits/1v1-lol/index.html';
    openSecureBrowser(urls1);
}
function openSecureBrowser2() {
    var urls2 = '/maplegrovecitylimits/FoundationINCCorporateTeam%203kh0-assets%20fixy%20slope-2/index.html';
    openSecureBrowser(urls2);
}
function openSecureBrowser3() {
    var urls3 = '/maplegrovecitylimits/FoundationINCCorporateTeam%203kh0-assets%20fixy%20slope/index.html';
    openSecureBrowser(urls3);
}
function openSecureBrowser4() {
    var urls4 = '/maplegrovecitylimits/stickman-hook/index.html';
    openSecureBrowser(urls4);
}
function openSecureBrowser5() {
    var urls5 = '/maplegrovecitylimits/FoundationINCCorporateTeam%203kh0-assets%20fixy%20worlds-hardest-game-2/index.html';
    openSecureBrowser(urls5);
}
function openSecureBrowser6() {
    var urls6 = '/maplegrovecitylimits/FoundationINCCorporateTeam%203kh0-assets%20fixy%20retro-bowl/index.html';
    openSecureBrowser(urls6);
}
function openSecureBrowser7() {
    var urls7 = '/maplegrovecitylimits/FoundationINCCorporateTeam%203kh0-assets%20fixy%20n-gon/index.html';
    openSecureBrowser(urls7);
}
function openSecureBrowser8() {
    var urls8 = '/maplegrovecitylimits/motox3m/motox3m/index.html';
    openSecureBrowser(urls8);
}
function openSecureBrowser9() {
    var urls9 = '/maplegrovecitylimits/FoundationINCCorporateTeam%203kh0-assets%20fixy%20death-run-3d/index.html';
    openSecureBrowser(urls9);
}
function openSecureBrowser10() {
    var urls9 = '/maplegrovecitylimits/FoundationINCCorporateTeam%203kh0-assets%20fixy%20basket-random/index.html';
    openSecureBrowser(urls9);
}
function openSecureBrowser11() {
    var urls9 = '/maplegrovecitylimits/FoundationINCCorporateTeam%203kh0-assets%20fixy%20bitlife/index.html';
    openSecureBrowser(urls9);
}
function openSecureBrowser12() {
    var urls9 = '/maplegrovecitylimits/FoundationINCCorporateTeam%203kh0-assets%20fixy%20flappy-bird/index.html';
    openSecureBrowser(urls9);
}
function openSecureBrowser13() {
    var urls9 = '/maplegrovecitylimits/FoundationINCCorporateTeam%203kh0-assets%20fixy%20rooftop-snipers/index.html';
    openSecureBrowser(urls9);
}
function openSecureBrowser14() {
    var urls9 = '/maplegrovecitylimits/FoundationINCCorporateTeam%203kh0-assets%20fixy%20sand-game/index.html';
    openSecureBrowser(urls9);
}
function openSecureBrowser15() {
    var urls9 = '/maplegrovecitylimits/FoundationINCCorporateTeam%20selenite-old%20main%20monkeymart/index.html';
    openSecureBrowser(urls9);
}
function openSecureBrowser16() {
    var urls9 = '/maplegrovecitylimits/basketball-stars/basketball-stars/index.html';
    openSecureBrowser(urls9);
}
function openSecureBrowser17() {
    var urls9 = '/maplegrovecitylimits/bit-planes/bit-planes/index.html';
    openSecureBrowser(urls9);
}
function openSecureBrowser18() {
    var urls9 = '/maplegrovecitylimits/core-ball/core-ball/index.html';
    openSecureBrowser(urls9);
}
function openSecureBrowser19() {
    var urls9 = '/maplegrovecitylimits/drive-mad/drive-mad/index.html';
    openSecureBrowser(urls9);
}
function openSecureBrowser20() {
    var urls9 = '/maplegrovecitylimits/theimpossiblequiz/index.html';
    openSecureBrowser(urls9);
}
function openSecureBrowser21() {
    var urls9 = '/maplegrovecitylimits/timeshooter2/index.html';
    openSecureBrowser(urls9);
}
function openSecureBrowser22() {
    var urls9 = '/maplegrovecitylimits/timeshooter3/index.html';
    openSecureBrowser(urls9);
}
function openSecureBrowser23() {
    var urls9 = '/maplegrovecitylimits/9007199254740992/9007199254740992/index.html';
    openSecureBrowser(urls9);
}
function openSecureBrowser24() {
    var urls9 = '/maplegrovecitylimits/tunnel-rush/tunnel-rush/index.html';
    openSecureBrowser(urls9);
}
